...
setup() ->
    ...
    meck:new(flurm_partition_manager, [passthrough, no_passthrough_cover, non_strict]),
    catch meck:unload(flurm_config_server),
    meck:new(flurm_config_server, [passthrough, no_passthrough_cover, non_strict]),
    catch meck:unload(flurm_controller_cluster),
    meck:new(flurm_controller_cluster, [passthrough, no_passthrough_cover, non_strict]),
    catch meck:unload(flurm_reservation),
    meck:new(flurm_reservation, [passthrough, no_passthrough_cover, non_strict]),
    catch meck:unload(flurm_license),
    meck:new(flurm_license, [passthrough, no_passthrough_cover, non_strict]),
    catch meck:unload(flurm_burst_buffer),
    meck:new(flurm_burst_buffer, [passthrough, no_passthrough_cover, non_strict]),
    catch meck:unload(flurm_step_manager),
    meck:new(flurm_step_manager, [passthrough, no_passthrough_cover, non_strict]),
