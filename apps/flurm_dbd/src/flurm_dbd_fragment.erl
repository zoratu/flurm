...
-export([
    ...
    create_job_table/4,
    maybe_create_burst_fragment/2,
    create_burst_fragment/2,
    update_record_count/3,
    get_all_job_tables/1,
    get_tables_for_range/3,
    find_job_in_tables/2,
    query_table_with_filters/2,
    matches_filters/2,
    delete_job_from_tables/2,
    perform_maintenance/1,
    age_tables/1,
    should_age_table/3,
    change_table_storage/3,
    archive_old_tables/2,
    update_table_sizes/1,
    time_to_period/1,
    parse_period/1,
    period_to_table_name/2,
    periods_between/2,
    determine_table_status/1,
    status_to_storage_type/1,
    map_to_job_record/1,
    job_record_to_map/1,
    fragment_meta_to_map/1,
    collect_table_stats/1
]).
-endif.
