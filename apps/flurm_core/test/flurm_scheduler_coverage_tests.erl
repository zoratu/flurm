...
setup() ->
    ...
    meck:new(flurm_job_manager, [passthrough, no_passthrough_cover, no_link]),
    meck:new(flurm_node_manager, [passthrough, no_passthrough_cover, non_strict, no_link]),
    meck:new(flurm_job_deps, [passthrough, no_passthrough_cover, no_link]),
    meck:new(flurm_license, [passthrough, no_passthrough_cover, no_link]),
    meck:new(flurm_limits, [passthrough, no_passthrough_cover, no_link]),
    meck:new(flurm_reservation, [passthrough, no_passthrough_cover, no_link]),
    ...
    meck:new(flurm_gres, [passthrough, no_passthrough_cover, no_link]),
    meck:new(flurm_metrics, [passthrough, no_passthrough_cover, non_strict, no_link]),
    meck:new(flurm_config_server, [passthrough, no_passthrough_cover, no_link]),
